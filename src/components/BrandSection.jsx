...
const BrandSection = () => (
  <section id="codeinntech" className="py-20 bg-white text-center text-gray-900">
    <div className="container mx-auto px-6">
      <motion.div
        className="glass-card animate-border-glow rounded-2xl p-10 max-w-3xl mx-auto border border-violet-200 shadow-lg shadow-violet-100/50"
